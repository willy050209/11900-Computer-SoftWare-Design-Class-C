...
public partial class MainForm : Form, IMainView
{
    ...
    public void ShowResults(IEnumerable<RoundResult> results)
    {
        dgvResults.Rows.Clear();
        foreach (var result in results)
        {
            dgvResults.Rows.Add(result.RoundIndex, result.PlayerCard.ToString(), result.BankerCard.ToString(), result.Result);
        }
    }
}
