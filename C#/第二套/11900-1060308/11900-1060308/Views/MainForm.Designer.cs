...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        colValue1 = new DataGridViewTextBoxColumn();
        colOp = new DataGridViewTextBoxColumn();
        colValue2 = new DataGridViewTextBoxColumn();
        ...
        grpCandidate.Size = new Size(890, 167);
        ...
        dgvResults.Columns.AddRange(new DataGridViewColumn[] { colValue1, colOp, colValue2, colAnswer });
        dgvResults.Location = new Point(17, 200);
        dgvResults.Margin = new Padding(4, 5, 4, 5);
        dgvResults.Name = "dgvResults";
        dgvResults.RowHeadersWidth = 62;
        dgvResults.Size = new Size(651, 550);
        dgvResults.TabIndex = 1;
        // 
        // colValue1
        // 
        colValue1.HeaderText = "VALUE1";
        colValue1.MinimumWidth = 8;
        colValue1.Name = "colValue1";
        // 
        // colOp
        // 
        colOp.HeaderText = "OP";
        colOp.MinimumWidth = 8;
        colOp.Name = "colOp";
        // 
        // colValue2
        // 
        colValue2.HeaderText = "VALUE2";
        colValue2.MinimumWidth = 8;
        colValue2.Name = "colValue2";
        // 
        // colAnswer
        // 
        colAnswer.HeaderText = "ANSWER";
        colAnswer.MinimumWidth = 8;
