...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.colSex = new DataGridViewTextBoxColumn();
        this.colError = new DataGridViewTextBoxColumn();
        ...
        this.dgvResults.Columns.AddRange(new DataGridViewColumn[] { this.colId, this.colName, this.colSex, this.colError });
